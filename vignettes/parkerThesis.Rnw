...
\section{Parker (1992) Thesis}

Some figures from Parker (1992) are reproduced here.
...
The skewness for a term policy is below.

<<echo=TRUE, fig=TRUE, eval=FALSE, include=FALSE, label=figure52>>=
oumodel = iratemodel(list(delta0 = 0.1, delta = 0.06, 
                          alpha = 0.1, sigma = 0.01), "ou")
...
n = seq(1,70,1)
skew1 = numeric(length(n))
skew10 = numeric(length(n))
skew100 = numeric(length(n))
skew1000 = numeric(length(n))
skewInf = numeric(length(n))
...
for(i in 41:70)
{
  ...
  skew1[i] = z.sk(port1,mort,oumodel)
  skew10[i] = z.sk(port10,mort,oumodel)
  skew100[i] = z.sk(port100,mort,oumodel)
  skew1000[i] = z.sk(port1000,mort,oumodel)
  skewInf[i] = z.sk(portInf,mort,oumodel)
}

pdf("C:/Users/nesau/Desktop/stocins/vignettes/parkerThesis-figure52.pdf")

plot(x = n, y = skew1, type = 'l', ylab = "sk", xlab = "n", 
     ylim = c(0, 30), xlim=c(0,46))
lines(x = n, y = skew10, type = 'l', lty = 2,xlim=c(0,40))
lines(x = n, y = skew100, type = 'l', lty = 3,xlim=c(0,40))
lines(x = n, y = skew1000, type = 'l', lty = 4,xlim=c(0,40))
lines(x = n, y = skewInf, type = 'l', lty = 5,xlim=c(0,40))
